...
超全的immutable.js持久化数据结构教程
https://www.bilibili.com/video/BV1Y4411x7af?p=10

Dva是一个基于redux和redux-saga的数据流方案，内置了react-router和featch，所以可以理解为一个轻量级饿的应用框架
...
why static method?
1、副作用：getDerivedStateFromProps 中的副作用意味着将更改除其自身局部变量之外的任何其他变量。不会产生副作用的函数称为纯函数
2、react 有自己的生命周期流的库引入异步代码并不优雅
