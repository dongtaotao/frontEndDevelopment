...
前端安全之XSS及CSRF  好文章
https://juejin.cn/post/7120609020070592542 
...
因为setTimeout的回调函数会在完成计时后被添加到宏任务队列中等待执行，但是如果此时主线程尚有任务执行，
就需要继续等待，所以setTimeout执行的条件是：计时完成并且主线程空闲
...
数据可视化大屏项目，我是如何实现多个大屏之间数据通信的 localStorage
https://juejin.cn/post/7197205708647465017
