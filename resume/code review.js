...
什么时候做Code Review
    ...
    什么时候进行Code Review
        开发前，开发中，提测前，上线后
    Committer需要注意什么
        限制每个commit的改动大小和范围，Commit信息要有意义
    Code Review需要看什么东西
        正确实现了功能或者修复了bug，确保编码风格一致
        避免非必要的复杂逻辑设计
        提高代码复用率
        写上必要的代码注释
...
当需求影响范围较大、复杂性较高、或实现方案有争议时，需要进行方案review。
    开发负责人在issue中初步制定方案，并记录主要问题点
    指定review成员进行review，共同讨论，形成结论记录到issue中
🌰Code Review – 开发中
...
🌰Code Review – 上线后
代码上线后，需要合并到master分支，记录并对比历史数据，及时作出改进。

对当期开发的重点需求和经典问题进行回顾：
    组织全组成员对标注的问题进行集体codereview。
    开发负责人对通过review发现的经典问题进行记录，改进后续开发流程
