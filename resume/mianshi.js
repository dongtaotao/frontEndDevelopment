...
面试官你好，我叫董涛，我目前在上海爱奇艺，在自爱奇艺已经三年多了，在爱奇艺主要负责公司性能监控分析平台网站的建设，
负责整体技术架构和主要开发工作，带团队 开发，
参与过公司 React-Native 框架维护(Js 部分以及 Native 与 Js 通信的桥接和 CICD)以及开发。
参与过 Flutter 框架的建设，落地公司第一 个 Flutter 项目。维护公司JSSDK等框架，也参与公司运营H5的开发等。
目前主要技术站是在react。但是vue，angular，小程序也是没有问题的。
平时喜欢调研一些新技术，写点技术博客（目前维护的 CSDN 技术博客访问量已经达到一千多万了）。
...
🔥🔥🔥🔥🔥🔥🔥🔥负责技术选型，项目框架搭建，集成框架React全家桶，让项目更加模块化，组件化，规范化，自动化。
    ...
    🌰更好的实现前端工程化 
        前端工程化不单单包括前端的模块化、组件化、规范化，自动化，还包括前端性能优化，前端目录规划，前端规范化，自动化测试，发布等等一系列知识。 
        为什么要工程化
        方便管理、专注开发、快速迭代等
